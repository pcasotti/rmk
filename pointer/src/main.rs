...
use rmk::input_device::rotary_encoder::{DefaultPhase, Direction, E8H7Phase, Phase, RotaryEncoder, RotaryEncoderProcessor};
...
async fn main(spawner: Spawner) {
    ...
    // Initialize IO Pins
    let (input_pins, output_pins) = config_matrix_pins_nrf!(peripherals: p, input: [P0_30, P0_31, P0_29, P0_27, P1_13], output:  [P0_28, P0_03, P1_10, P0_02, P0_06, P1_11, P0_13, P0_24, P0_09, P0_10, P1_01, P1_02, P1_03, P1_05]);
    ...
    let pin_c = Input::new(p.P0_11, embassy_nrf::gpio::Pull::None);
    let pin_d = Input::new(p.P1_00, embassy_nrf::gpio::Pull::None);
    let mut encoder2 = RotaryEncoder::with_phase(pin_c, pin_d, E8H7Phase, 1);
    ...
    let mut encoder_processor2 = RotaryEncoderProcessor::new(&keymap);
    ...
    join4(
        run_devices! (
            (matrix, encoder, encoder2, adc_device) => EVENT_CHANNEL,
        ),
        run_processor_chain! {
            EVENT_CHANNEL => [encoder_processor, encoder_processor2, batt_proc],
        },
