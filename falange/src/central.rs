...
async fn main(spawner: Spawner) {
    ...
    // Initialize IO Pins
    let (input_pins, output_pins) = config_matrix_pins_nrf!(peripherals: p, input: [P0_22, P0_24, P1_00, P1_04], output: [P0_09, P0_10, P1_11, P0_11, P1_06]);
    ...
    let storage_config = StorageConfig {
        start_addr: 655360, // FIXME: use 0x70000 after we can build without softdevice controller
        num_sectors: 32,
        ..Default::default()
    };
    ...
    let debouncer = DefaultDebouncer::<4, 10>::new();
    ...
    let peripheral_addrs = read_peripheral_addresses::<1, _, 4, 10, 8, 0>(&mut storage).await;
